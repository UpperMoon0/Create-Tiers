...
REQUIRED_SCENARIOS = (
    ...
    "itemless-belt-cannot-mint-tier",
    "itemless-powered-shaft-cannot-mint-tier",
    "unregistered-tier-data-rejected",
    "forged-replacement-source-rejected",
    "placement-helper-shaft-tier-preservation",
    "placement-helper-steam-tier-preservation",
    "registered-pulley-item-roundtrip",
    "intrinsic-pulley-item-roundtrip",
    "registered-pulley-direct-mining",
    "intrinsic-pulley-direct-mining",
    "registered-pulley-slicer-shortening",
    "intrinsic-pulley-slicer-shortening",
