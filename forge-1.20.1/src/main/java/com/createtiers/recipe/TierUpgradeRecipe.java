...
public final class TierUpgradeRecipe extends ShapelessRecipe {
    ...
    public TierUpgradeRecipe(ResourceLocation recipeId, ResourceLocation tierId, ResourceLocation inputId,
    ...
    private TierUpgradeRecipe(ResourceLocation recipeId, ResourceLocation tierId, ResourceLocation inputId,
    ...
    public static final class Serializer implements RecipeSerializer<TierUpgradeRecipe> {
        ...
        public TierUpgradeRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            try {
                return new TierUpgradeRecipe(recipeId, tierId, inputId, ingredients);
            } catch (IllegalArgumentException ex) {
                throw new JsonParseException("Invalid tier-upgrade recipe " + recipeId + ": " + ex.getMessage(), ex);
            }
        }
