...
public class TieredCogwheelBlockItem extends BlockItem {
    ...
    private static final int smallPlacementHelperId = PlacementHelpers.register(new SmallCogHelper());
    private static final int largePlacementHelperId = PlacementHelpers.register(new LargeCogHelper());
    private static final int smallIntegratedCogHelperId = PlacementHelpers.register(new IntegratedSmallCogHelper());
    private static final int largeIntegratedCogHelperId = PlacementHelpers.register(new IntegratedLargeCogHelper());

    public TieredCogwheelBlockItem(TieredCogwheelBlock block, Properties builder) {
        super(block, builder);
        large = block.isLargeCogwheel();
    }
    ...
    public InteractionResult onItemUseFirst(ItemStack stack, UseOnContext context) {
        ...
        IPlacementHelper helper = PlacementHelpers.get(large ? largePlacementHelperId : smallPlacementHelperId);
        ...
        int integratedCogHelperId = large ? largeIntegratedCogHelperId : smallIntegratedCogHelperId;
    ...
    private static class SmallCogHelper extends DiagonalCogHelper {
        ...
        public Predicate<ItemStack> getItemPredicate() {
            return i -> i.getItem() instanceof TieredCogwheelBlockItem item && !item.large;
        }
    ...
    public static class IntegratedLargeCogHelper implements IPlacementHelper {
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            for (Direction d : directions) {
                ...
                return PlacementOffset.success(newPos, s -> s.setValue(RotatedPillarKineticBlock.AXIS, newAxis));
            }
